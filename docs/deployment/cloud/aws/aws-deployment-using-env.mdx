...
<Note>This guide focuses on deploying the application using docker image and ec2 instance combined.</Note>
...
### Run the Init script to initialise the application :  
