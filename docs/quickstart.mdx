...
<Tip> If you have postgres running, we suggest you kill the porocess before starting docker </Tip>
...
<Info> Wait for the application to start running, this can take around 10 - 15 minutes. </Info>
...
In the ```.env.temp``` file, you can modify the following :
