...
<Note> Due to our agentic RAG implementation, the maximum TPM limit exceeds for Open AI's gpt4o model. </Note>
<Tip> For the best experience, we recommend using AWS Bedrock or Claude, as it enhances performance and accuracy. </Tip>
...
<Tip>For the best experience, we recommend using AWS Bedrock with Claude, as it enhances performance and accuracy.</Tip>
