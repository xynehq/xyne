...
<Tip> Also ensure that you're able to generate chat output using your downloaded ollama model , you can use ```ollama run your_model_name Hello```. This should return an output confirming ollama is working.</Tip> 
