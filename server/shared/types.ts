...
import { entitySchema, VespaFileSchema, VespaUserSchema, Apps } from '../search/types'
export { GooglePeopleEntity, DriveEntity, NotionEntity, Apps } from '../search/types'
...
export const AutocompleteFileSchema = z.object({
    type: z.literal('file'),
    relevance: z.number(),
    title: z.string(),
...
export const SearchResultsSchema = z.discriminatedUnion('type', [
    UserResponseSchema, FileResponseSchema
]);
