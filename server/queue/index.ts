import { handleGoogleOAuthIngestion, handleGoogleServiceAccountIngestion, syncGoogleWorkspace } from "@/integrations/google";
import { ConnectorType, type SaaSJob } from "@/types";
import PgBoss from "pg-boss";
import config from "@/config"
import { Apps, AuthType } from "@/shared/types";
import { handleGoogleOAuthChanges, handleGoogleServiceAccountChanges } from "@/integrations/google/sync";
