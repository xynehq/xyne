...
const DEFAULT_STATUS_ENDPOINT_VALUE = "http://localhost:8081/instance_status"
const DEFAULT_STATUS_ENDPOINT = process.env.STATUS_ENDPOINT || DEFAULT_STATUS_ENDPOINT_VALUE
