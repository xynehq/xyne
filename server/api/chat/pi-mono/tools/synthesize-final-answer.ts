/**
   ...
   const synthesizeFinalAnswerParams = Type.Object({
     insightsUsefulForAnswering: Type.Optional(Type.String({
       description: "Optional guidance to help the final answer model emphasize key conclusions, ordering, or non-obvious takeaways.",
     })),
   })
