/**
   ...
   export function buildTargetFromParams(params: {
     ...
     fileId?: string
     path?: string
   }): { type: "collection"; collectionId: string } | { type: "folder"; folderId: string } | { type: "file"; fileId: string } | { type: "path"; collectionId: string; path: string } | undefined {
     ...
     switch (params.type) {
       ...
       case "path":
         ...
         return { type: "path" as const, collectionId: params.collectionId, path: params.path }
       default:
         return undefined
     }
   }
   ...
   ): Array<{ type: "collection"; collectionId: string } | { type: "folder"; folderId: string } | { type: "file"; fileId: string } | { type: "path"; collectionId: string; path: string }> | undefined {
    ...
    */
   export function parseTimeRange(timeRange?: TimeRangeInput): TimeRangeOutput | undefined {
    ...
    */
   export function normalizeSortBy(sortBy: "asc" | "desc" | undefined, defaultValue: "asc" | "desc" = "desc"): "asc" | "desc" {
