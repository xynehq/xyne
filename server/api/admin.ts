...
export const CreateZohoDeskConnector = async (c: Context) => {
  ...
  try {
    ...
    // Console log full department details for visibility
    console.log("\n📋 ADMIN CONNECTOR: Full Department Details")
    console.log("==========================================")
    console.log(`User Email: ${userInfo.email}`)
    console.log(`Total Departments: ${userInfo.associatedDepartmentIds.length}`)
    console.log("\nDepartment IDs:")
    console.log(JSON.stringify(userInfo.associatedDepartmentIds, null, 2))
    console.log("\nDepartment Details:")
    console.log(JSON.stringify(userInfo.associatedDepartments, null, 2))
    console.log("==========================================\n")
