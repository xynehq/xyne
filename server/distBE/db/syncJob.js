import { selectSyncJobSchema, syncJobs } from "./schema.js"
import { createId } from "@paralleldrive/cuid2";
import { and, eq } from "drizzle-orm";
import { z } from "zod";
export const insertSyncJob = async (trx, job) => {
...
export const getAppSyncJobs = async (trx, app, authType) => {
...
export const updateSyncJob = async (trx, jobId, updateData) => {
