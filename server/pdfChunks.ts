              ...
              if (imageProcessed) {
                ...
                if (seenHashDescriptions.has(imageHash)) {
                  ...
                  if (
                    ...
                    Logger.warn(`${description} ${imageName} on page ${pageNum}`)
                    continue
                  }
                ...
                try {
                  ...
                  const imageFilename = `${docid}_${globalSeq.value}.png`
...
// Remove the test code at the bottom - this should not be in production
// extractTextAndImagesWithChunks("/Users/himansh.varma/Desktop/xyne/server/eval/2307.06435v10.pdf", "06435v10").then((result) => {
//   console.log(result);
// })
