...
export enum VertexAIModels {
  ...
  Gemini_3_Pro = "vertex-gemini-3-pro-preview",
  Gemini_3_Flash = "vertex-gemini-3-flash-preview",
}
...
export enum Models {
  ...
  Vertex_Gemini_3_Pro = VertexAIModels.Gemini_3_Pro,
  Vertex_Gemini_3_Flash = VertexAIModels.Gemini_3_Flash,
...
export enum ModelDisplayNames {
  ...
  VERTEX_GEMINI_3_PRO = "Gemini 3 Pro", // 3.0 Pro
  VERTEX_GEMINI_3_FLASH = "Gemini 3 Flash", // 3.0 Flash
...
export const TicketParticipantSchema = z.object({
  // Ticket Identifier
  ticketNumber: z.array(z.string()).optional(), // Ticket numbers (e.g., "763526", "751480")

  // People/Assignment filters
  assigneeEmail: z.array(z.string()).optional(), // Assignee emails
  contact: z.array(z.string()).optional(), // Contact/requester emails
  departmentName: z.array(z.string()).optional(), // Department names
...
export const FiltersSchema = z.object({
  ...
  timestampField: z
    .enum(["createdTime", "modifiedTime", "closedTime", "dueDate"])
    .optional(), // Optional: which timestamp field to filter on (for schemas with multiple time fields like ticket schema)
