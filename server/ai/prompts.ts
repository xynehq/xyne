    ...
    ${
      isWebScraperContent
        ? `**CRITICAL - WEB SCRAPER CONTENT DETECTED**:
           ...
           **ABSOLUTE REQUIREMENT**: You are REQUIRED to generate an answer using the scraped content above.
           **DO NOT return null** - the scraped content contains the information needed to answer the user's query.
           **MANDATORY**: Extract relevant information from the scraped content and provide a comprehensive answer.`
