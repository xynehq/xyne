...
export const syncJobDuration = new Histogram({
    ...
    labelNames:["sync_job_name", "sync_job_start_time", "sync_job_auth_type"],
...
export const syncJobSuccess = new Counter({
    ...
    labelNames:["sync_job_name", "sync_job_start_time", "sync_job_end_time", "sync_job_auth_type"]
})
...
export const internalSyncJobSuccess = new Counter({
    ...
    labelNames:["sync_job_internal_name","sync_job_entity", "sync_job_start_time", "sync_job_end_time", "sync_job_auth_type", "sync_job_name"]
})
...
export const syncJobError = new Counter({
    ...
    labelNames:["sync_job_name", "sync_job_start_time", "sync_job_end_time", "sync_job_error_type", "sync_job_auth_type"]
})
...
export const internalSyncJobError = new Counter({
    ...
    labelNames:["sync_job_internal_name","sync_job_entity", "sync_job_start_time", "sync_job_end_time","sync_internal_job_error_type", "sync_job_auth_type", "sync_job_name"]
})
