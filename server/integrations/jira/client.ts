...
export class JiraClient {
  ...
  async getStatuses(): Promise<any[]> {
    try {
      ...
      throw new Error(`Failed to get statuses: ${formatJiraError(error)}`)
    }
  }
  ...
  async getProjectStatuses(projectKey: string): Promise<any[]> {
    try {
      ...
      throw new Error(`Failed to get project statuses: ${formatJiraError(error)}`)
    }
  }
  ...
  async getComponents(projectKey: string): Promise<any[]> {
    try {
      ...
      throw new Error(`Failed to get components: ${formatJiraError(error)}`)
    }
  }
  ...
  async getEpics(projectKey: string): Promise<any[]> {
    try {
      ...
      throw new Error(`Failed to get epics: ${formatJiraError(error)}`)
    }
  }
