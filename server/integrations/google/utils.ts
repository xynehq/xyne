...
export const getFile = async (client: GoogleClient, fileId: string): Promise<drive_v3.Schema$File> => {
    console.log('getFile')
...
export const driveFileToIndexed = (file: drive_v3.Schema$File): VespaFileWithDrivePermission => {
