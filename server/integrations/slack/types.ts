...
export function isValidSearchResult(obj: unknown): obj is SearchResult {
  ...
  const hasIdentifier = typeof result.id === 'string' || 
...
export function isValidConversationMessage(obj: unknown): obj is ConversationMessage {
  if (!obj || typeof obj !== 'object') return false;
...
export function validateConversationHistory(messages: unknown[]): ConversationMessage[] {
