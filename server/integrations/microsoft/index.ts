...
import { CalendarEntity, eventSchema } from "@/search/types"
import {
...
export const handleMicrosoftOAuthIngestion = async (data: SaaSOAuthJob) => {
  ...
  try {
    ...
    const [outlookDeltaToken, { calendarEventsToken }] = await Promise.all([
