...
const mockOcrResponse = {
  "0": [
    {
      ...
      "block_content": "Building blocks poised to bring 10Ximpact for  our travel partners, across the ecosysem "
    },
    {
      "block_label": "image",
      "block_bbox": [
  ...
  "1": [
    ...
    },
    {
      ...
      "block_content": "lf a transaction fails because of a technical reason, we retry the transaction with a different PSP.\n"
    },
    {
      "block_label": "text",
      "block_bbox": [
      ...
      "block_content": "Te decision whether to retry or not is based on errorreason.\n"
    },
    {
      "block_label": "paragraph_title",
      "block_bbox": [
  ...
  "2": [
    ...
    },
    {
      ...
      "block_content": "Adaptive payment flows based on  yourdata ＆fallback3DS newuser "
    },
    {
      "block_label": "text",
      "block_bbox": [
      ...
      "block_content": "Select the most optimized flow to balance user experience and fraud prevention, leveraging customerand payment data."
    },
    {
      "block_label": "image",
      "block_bbox": [
...
async function testChunkByOCR() {
  try {
    ...
    // Load the image file
    const imagePath = "/Users/aayush.shah/Downloads/robust_test_images/page-1-image-1.png";
    ...
    result.text_chunks.forEach((chunk, index) => {
      ...
      if (result.text_chunks_pos[index]) {
        ...
        console.log(`Block labels: [${result.text_chunks_pos[index].block_labels.join(", ")}]`);
      }
    });
    ...
    result.image_chunks.forEach((imageChunk, index) => {
      ...
      if (result.image_chunk_pos[index]) {
        ...
        console.log(`Block labels: [${result.image_chunk_pos[index].block_labels.join(", ")}]`);
      }
    });
    ...
    result2.chunks.forEach((chunk, index) => {
      ...
      if (result2.chunks_pos[index]) {
        ...
        console.log(`Block labels: [${result2.chunks_pos[index].block_labels.join(", ")}]`);
      }
    });
    ...
    result2.image_chunks.forEach((imageChunk, index) => {
      ...
      if (result2.image_chunks_pos[index]) {
        ...
        console.log(`Block labels: [${result2.image_chunks_pos[index].block_labels.join(", ")}]`);
      }
    });
    ...
    console.log(`Image chunks metadata count: ${result2.image_chunks_pos.length}`);
