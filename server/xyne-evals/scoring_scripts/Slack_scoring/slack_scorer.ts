...
const DEFAULT_INPUT_FILE = "./slack_both.json"
const DEFAULT_OUTPUT_FILE = "./slack_both_eval.json"
  ...
  try {
    ...
    for (let i = 0; i < scoredResults.length; i++) {
      ...
      if (
        ...
        typeof result.score_agentic.DomainRelevance === "number"
      ) {
      ...
      if (
        ...
        typeof result.score_Non_agentic.DomainRelevance === "number"
      ) {
      ...
      if (result.score && typeof result.score.DomainRelevance === "number") {
        scoredItem.overall_score =
          result.overall_score || calculateOverallScore(result.score)
        console.log(
          `✅ Batch ${batchNumber}, item ${i}: Valid legacy score received.`,
        )
        isValid = true
      }
  ...
  try {
    ...
    for (const item of allScoredResults) {
      if (
        ...
        summary.agentic.avg_scores.DomainRelevance +=
          item.score_agentic.DomainRelevance
        summary.agentic.avg_scores.Factuality += item.score_agentic.Factuality
        summary.agentic.avg_scores.SemanticSimilarity +=
          item.score_agentic.SemanticSimilarity
      ...
      if (
        ...
        summary.non_agentic.avg_scores.DomainRelevance +=
          item.score_Non_agentic.DomainRelevance
        summary.non_agentic.avg_scores.Factuality +=
          item.score_Non_agentic.Factuality
        summary.non_agentic.avg_scores.SemanticSimilarity +=
          item.score_Non_agentic.SemanticSimilarity
      ...
      if (item.score && typeof item.overall_score === "number") {
        ...
        summary.legacy.avg_scores.SemanticSimilarity +=
          item.score.SemanticSimilarity
    ...
    const calculateAverages = (data: any) => {
      if (data.count > 0) {
        ...
        data.avg_scores.DomainRelevance =
          Math.round((data.avg_scores.DomainRelevance / data.count) * 100) / 100
        data.avg_scores.Factuality =
          Math.round((data.avg_scores.Factuality / data.count) * 100) / 100
        data.avg_scores.SemanticSimilarity =
          Math.round((data.avg_scores.SemanticSimilarity / data.count) * 100) /
          100
    ...
    if (summary.agentic.count > 0) {
      ...
      console.log(
        `   - Average Domain Relevance: ${summary.agentic.avg_scores.DomainRelevance}/10`,
      )
      console.log(
        `   - Average Factuality: ${summary.agentic.avg_scores.Factuality}/10`,
      )
      console.log(
        `   - Average Semantic Similarity: ${summary.agentic.avg_scores.SemanticSimilarity}/10`,
      )
      console.log(
    ...
    if (summary.non_agentic.count > 0) {
      ...
      console.log(
        `   - Average Domain Relevance: ${summary.non_agentic.avg_scores.DomainRelevance}/10`,
      )
      console.log(
        `   - Average Factuality: ${summary.non_agentic.avg_scores.Factuality}/10`,
      )
      console.log(
        `   - Average Semantic Similarity: ${summary.non_agentic.avg_scores.SemanticSimilarity}/10`,
      )
      console.log(
    ...
    if (summary.legacy.count > 0) {
      ...
      console.log(
        `   - Average Domain Relevance: ${summary.legacy.avg_scores.DomainRelevance}/10`,
      )
      console.log(
        `   - Average Factuality: ${summary.legacy.avg_scores.Factuality}/10`,
      )
      console.log(
        `   - Average Semantic Similarity: ${summary.legacy.avg_scores.SemanticSimilarity}/10`,
      )
      console.log(
