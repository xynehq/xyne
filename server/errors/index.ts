...
type IntegrationErrorPartialMsgOpts = Omit<IntegrationErrorOpts, "message"> & Partial<Pick<IntegrationErrorOpts, "message">> & ErrorOpts


class IntegrationsError extends Error {
    constructor({ message, integration, entity, op, docId, jobId, cause }: IntegrationErrorOpts) {
...
type vespaErrorOpts = Omit<VespaErrorOpts, "message"> & Partial<Pick<VespaErrorOpts, "message">>
