  ...
  return (
    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-3 shadow-lg">
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        <div>
          <Label htmlFor="from" className="text-sm">Source Node (From) *</Label>
          <select
            id="from"
            value={formData.from}
        ...
        <div>
          <Label htmlFor="to" className="text-sm">Target Node (To) *</Label>
          <select
            id="to"
            value={formData.to}
        ...
        <div>
          <Label htmlFor="relationship" className="text-sm">Relationship Type *</Label>
          <Input
            id="relationship"
          ...
          <div className="text-xs text-gray-500 mt-1">
            Direction: {formData.from && formData.to && nodes.find((n: GraphNode) => n.id === formData.from)?.name && nodes.find((n: GraphNode) => n.id === formData.to)?.name ? 
