...
export const ChatBox = ({
  ...
  return (
    <div className="relative flex flex-col w-full max-w-3xl pb-5">
      ...
      <div
        className={`flex flex-col w-full border dark:border-gray-700 ${persistedAgentId && displayAgentName ? "rounded-b-[20px] rounded-t-none !border-t-0" : "rounded-[20px]"} bg-white dark:bg-[#1E1E1E] ${CLASS_NAMES.SEARCH_CONTAINER}`}
      >
