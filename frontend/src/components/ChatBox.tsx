      ...
      <div className="flex flex-col w-full border rounded-[20px] bg-white">
        ...
        <div className="flex ml-[16px] mr-[6px] mb-[6px] items-center space-x-3 pt-1 pb-1">
          ...
          <button
            ...
            className={`flex mr-6 bg-[#464B53] text-white ${
              !isStreaming ? "hover:bg-[#5a5f66]" : ""
            } rounded-full w-[32px] h-[32px] items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed`}
          >
