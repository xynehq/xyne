  ...
  if (formTool && formTool.type === "form") {
    ...
    for (const field of formFields) {
      if (
        ...
        const customTypes = field.fileTypes.filter(
          ...
          {workflow.SharedUserMetadata && (
            <div className="relative group">
              <p className="text-sm text-gray-600 dark:text-gray-400 font-medium">
                Shared by{" "}
                <button className="border border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-900/20 px-1.5 py-0.5 rounded-full transition-colors text-gray-600 dark:text-gray-400">
