...
export const JiraConfigurationUI: React.FC<JiraConfigurationUIProps> = ({
  ...
  return (
    <div className="fixed top-[80px] right-0 h-[calc(100vh-80px)] w-[450px] bg-white dark:bg-gray-900 shadow-2xl z-50 flex flex-col animate-slide-in-right border-l border-gray-200 dark:border-gray-700">
      {/* Header */}
