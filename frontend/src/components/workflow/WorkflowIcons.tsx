...
// Tool Icons
export const DelayIcon: React.FC<IconProps> = ({ className = "w-4 h-4", width = 24, height = 24 }) => (
...
export const PythonScriptIcon: React.FC<IconProps> = ({ className = "w-4 h-4", width = 24, height = 24 }) => (
  <svg className={className} width={width} height={height} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export const DefaultToolIcon: React.FC<IconProps> = ({ className = "w-4 h-4", width = 24, height = 24 }) => (
  <svg className={className} width={width} height={height} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
// Header Icons
export const EditorIcon: React.FC<IconProps> = ({ className = "w-3.5 h-3.5", width = 24, height = 24 }) => (
  <svg className={className} width={width} height={height} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export const SettingsIcon: React.FC<IconProps> = ({ className = "w-3.5 h-3.5", width = 24, height = 24 }) => (
  <svg className={className} width={width} height={height} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
// Trigger Icons
export const ManualTriggerIcon: React.FC<IconProps> = ({ className = "", width = 20, height = 20 }) => (
  <svg className={className} width={width} height={height} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <circle cx="12" cy="12" r="10"></circle>
...
export const AppEventIcon: React.FC<IconProps> = ({ className = "", width = 20, height = 20 }) => (
  <svg className={className} width={width} height={height} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export const ScheduleIcon: React.FC<IconProps> = ({ className = "", width = 20, height = 20 }) => (
  <svg className={className} width={width} height={height} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <circle cx="12" cy="12" r="10"></circle>
    <polyline points="12 6 12 12 16 14"></polyline>
  </svg>
...
export const WebhookIcon: React.FC<IconProps> = ({ className = "", width = 20, height = 20 }) => (
  <svg className={className} width={width} height={height} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export const FormSubmissionIcon: React.FC<IconProps> = ({ className = "", width = 20, height = 20 }) => (
  <svg className={className} width={width} height={height} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export const WorkflowExecutionIcon: React.FC<IconProps> = ({ className = "", width = 20, height = 20 }) => (
  <svg className={className} width={width} height={height} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline>
  </svg>
);

export const ChatMessageIcon: React.FC<IconProps> = ({ className = "", width = 20, height = 20 }) => (
  <svg className={className} width={width} height={height} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
// Resource Icons
export const HelpIcon: React.FC<IconProps> = ({ className = "", width = 20, height = 20 }) => (
  <svg className={className} width={width} height={height} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <circle cx="12" cy="12" r="10"></circle>
...
export const TemplatesIcon: React.FC<IconProps> = ({ className = "", width = 20, height = 20 }) => (
  <svg className={className} width={width} height={height} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
    <polyline points="14 2 14 8 20 8"></polyline>
    <line x1="16" y1="13" x2="8" y2="13"></line>
...
// Empty Canvas Icon
export const AddIcon: React.FC<IconProps> = ({ className = "w-5 h-5", width = 24, height = 24 }) => (
  <svg className={className} width={width} height={height} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
