...
const QAAgentConfigUI: React.FC<QAAgentConfigUIProps> = ({
  isVisible,
  onBack,
  onClose,
  onSave,
...
1. Is clear and specific about the Q&A agent's role
2. Includes proper behavioral guidelines for answering questions
3. Has clear instructions for output format
4. Maintains the original purpose but makes it more professional for Q&A tasks
...
- Provide clear, concise, and accurate answers to each question
- Maintain a professional and helpful tone at all times
- If a question is unclear or ambiguous, provide the best possible interpretation
- For questions that cannot be answered definitively, explain what information would be needed
- Keep answers focused and relevant to the specific question asked

OUTPUT REQUIREMENTS:
- Provide direct answers without unnecessary elaboration unless specifically requested
...
Process each question independently and provide thoughtful, well-reasoned answers.`
...
export default QAAgentConfigUI