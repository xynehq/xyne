    ...
    <div className={`h-full bg-white border-l border-slate-200 flex flex-col overflow-hidden transition-transform duration-300 ease-in-out ${
      ...
      <div className="flex-1 overflow-y-auto px-6 py-6">
        <div className="space-y-6">
          ...
          {/* Agent Description */}
          <div className="space-y-2">
            <Label htmlFor="agent-description" className="text-sm font-medium text-slate-700">
              Agent Description
            </Label>
            <Textarea
          ...
          {/* Input Prompt */}
          <div className="space-y-2">
            <Label htmlFor="input-prompt" className="text-sm font-medium text-slate-700">
            ...
            <div className="relative">
              <Input
                ...
                onChange={(e) => setAgentConfig(prev => ({ ...prev, inputPrompt: e.target.value }))}
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-xs text-slate-500">
              A system prompt is the initial instruction that sets an AI model's behavior, style, and constraints.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              >
                ...
                <ChevronDown className={`w-4 h-4 text-slate-500 transition-transform ${isKnowledgeDropdownOpen ? 'rotate-180' : ''}`} />
              </button>
