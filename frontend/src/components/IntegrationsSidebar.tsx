...
export const IntegrationsSidebar = ({
  ...
  return (
    <TooltipProvider>
      <div className={`max-w-sm w-[300px] ${isExpanded ? "ml-[200px]" : "ml-[52px]"} h-full border-r-[0.5px] border-[#D7E0E9] dark:border-gray-700 flex flex-col select-none bg-white dark:bg-[#1E1E1E] transition-all duration-300 ease-in-out`}>
