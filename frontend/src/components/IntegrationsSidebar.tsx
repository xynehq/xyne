      ...
      <div className="max-w-sm w-[300px] ml-[52px] h-full border-r-[0.5px] border-[#D7E0E9] dark:border-gray-700 flex flex-col select-none bg-white dark:bg-[#1E1E1E]">
        ...
        <div className="flex-1 overflow-auto mt-[15px]">
          <ul>
            ...
            >
              <span className="text-[14px] font-semibold text-blue-600 dark:text-blue-400 ml-[8px]">
                Z
              </span>
              <span className="text-[14px] dark:text-gray-200 pl-[10px] pr-[10px] truncate cursor-pointer flex-grow max-w-[250px]">
                Zoho Desk
            ...
            <li
              className={`group flex justify-between items-center ${location.pathname.includes("/integrations/database") ? "bg-[#EBEFF2] dark:bg-slate-700" : ""} hover:bg-[#EBEFF2] dark:hover:bg-slate-700 rounded-[6px] pt-[8px] pb-[8px] ml-[8px] mr-[8px] cursor-pointer`}
              onClick={() => {
                router.navigate({
                  to:
                    role === UserRole.SuperAdmin || role === UserRole.Admin
            ...
            >
              <Database className="w-4 h-4 ml-[8px] dark:text-gray-300" />
              <span className="text-[14px] dark:text-gray-200 pl-[10px] pr-[10px] truncate cursor-pointer flex-grow max-w-[250px]">
                Database
              </span>
            </li>
