...
export const TimelineFilter: React.FC<TimelineFilterProps> = ({
  ...
  const handleTimelineSelect = (timelineOption: {
    label: string
    value: string
  }) => {
    ...
    const newSelection =
      selectedTimeline === timelineOption.label ? null : timelineOption.label
    ...
    const existingNonTimelineFilters = currentFilters.filter(
      (f) => !f.startsWith("~"),
    )

    const combinedFilters = [
      ...selectedTimelineNames,
      ...existingNonTimelineFilters,
    ]
            ...
            >
              <input
                ...
                checked={
                  ...
                  (timelineOption.label === "Custom date" &&
                    selectedTimeline?.includes("→"))
                }
                onChange={() => {}}
              />
