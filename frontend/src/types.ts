...
export const searchSchema = z.object({
    ...
    offset: z.union([z.string(), z.undefined(), z.number(), z.null()]).transform(x => Number(x ?? 0)).pipe(z.number().min(0)).optional(),
    // removed min page size for filters
    page: z.union([z.string(), z.undefined(), z.number(), z.null()]).transform(x => Number(x ?? 8)).pipe(z.number()).optional(),
