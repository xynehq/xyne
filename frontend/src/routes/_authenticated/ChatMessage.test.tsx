...
const baseProps = {
  ...
  describe('Thinking State Scenarios', () => {
    ...
    expect(screen.getByText(new RegExp(`${THINKING_PLACEHOLDER}\\.\\.\\.`, "i")), 'Initial: "Thinking..." text should be visible').toBeInTheDocument();
    ...
    expect(screen.queryByText(new RegExp(THINKING_PLACEHOLDER, "i")), 'After stop (empty message): "Thinking" text should NOT be visible').not.toBeInTheDocument();
    ...
    expect(screen.queryByText(new RegExp(THINKING_PLACEHOLDER, "i")), 'Initial completed: "Thinking" should not be visible').not.toBeInTheDocument();
    ...
    expect(screen.getByText(new RegExp(`${THINKING_PLACEHOLDER}\\.\\.\\.`, "i")), 'During retry: "Thinking..." text should be visible').toBeInTheDocument();
    ...
    expect(screen.queryByText(new RegExp(THINKING_PLACEHOLDER, "i")), 'After stopping retry: "Thinking" text should NOT be visible').not.toBeInTheDocument();
