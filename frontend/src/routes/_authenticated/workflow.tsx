  ...
  const handleViewExecution = async (executionId: string) => {
    try {
      ...
      const response = await fetch(
        `${BACKEND_BASE_URL}/api/v1/workflow/executions/${executionId}`,
        {
          headers: {
      ...
      if (executionData) {
        ...
        if (
          ...
          console.log(
            "❌ Execution data does not have valid stepExecutions or steps structure, trying to create workflow from execution data",
          )
          ...
          if (steps.length > 0) {
            ...
            setViewMode("builder")
            console.log(
              "✅ Successfully created and set workflow from execution data",
            )
          } else {
            console.error(
            ...
            <div className="w-full">
              ...
              {activeTab === "workflow" && (
                <div className="space-y-8">
                  ...
                  <div>
                    <h2
                      className="text-gray-900 dark:text-gray-400 uppercase mb-6"
                      style={{
                        ...
                        {workflows.map((workflow) => (
                          <WorkflowCard
                            ...
                            onViewClick={(templateId) =>
                              handleViewWorkflow(templateId, true)
                            } // true = editable mode
                          />
                        ))}
                      </div>
