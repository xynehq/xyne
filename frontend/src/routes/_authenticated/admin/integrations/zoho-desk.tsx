...
export const ZohoDesk = ({
  ...
  const { isPending, data, refetch } = useQuery<Connector[]>({
  ...
  const handleStartSync = async () => {
    ...
    try {
      ...
      toast({
        title: "Sync Started",
        description:
          result.message || "Zoho Desk sync has been triggered successfully.",
      })
    } catch (error) {
      toast({
        ...
        <div className="flex flex-col h-full items-center justify-center">
          <Card className="w-[500px]">
            <CardHeader>
              ...
              <CardDescription>
                Configure admin-level Zoho Desk integration. Tickets will be
                synced daily at 2 AM.
              </CardDescription>
            </CardHeader>
            <CardContent>
              {isPending ? (
            ...
            <div className="mt-6 w-[500px]">
              <Card>
                ...
                <CardContent className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <p>
                    <strong>Sync Type:</strong> Incremental (only modified
                    tickets)
                  </p>
                  <p>
                    <strong>Permissions:</strong> Department-based access
                    control
                  </p>
                  <p>
                    <strong>Data Synced:</strong> Tickets, threads, comments,
                    and attachments
                  </p>
                  <p className="mt-4 text-xs">
                    Note: Attachment OCR processing happens asynchronously after
                    sync.
                  </p>
                </CardContent>
              </Card>
