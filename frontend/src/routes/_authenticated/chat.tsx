  ...
  return (
    <div className="h-full w-full flex flex-row bg-white dark:bg-[#1E1E1E]">
      ...
      <div className="h-full w-full flex flex-col relative">
        <div
          className={`flex w-full fixed bg-white dark:bg-[#1E1E1E] h-[48px] border-b-[1px] border-[#E6EBF5] dark:border-gray-700 justify-center  transition-all duration-250 z-20 ${showSources ? "pr-[18%]" : ""}`}
        >
