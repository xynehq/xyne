...
export const ChatMessage = ({
  ...
  if (isUser) {
    return (
      <div className="flex items-center self-end max-w-full min-w-0 mt-[40px]">
        <div className="rounded-[16px] bg-[#F0F2F4] dark:bg-slate-700 text-[#1C1D1F] dark:text-slate-100 text-[15px] leading-[25px] pt-[14px] pb-[14px] pl-[20px] pr-[20px] break-words overflow-wrap-anywhere">
          <div
  ...
  return (
    <div
      className={`max-w-full min-w-0 text-[#1C1D1F] dark:text-[#F1F3F4] text-[15px] leading-[25px] self-start w-full`}
    >
      <div
