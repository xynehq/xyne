            ...
            >
              <div className="flex pl-[12px] pt-[10px] pr-[12px]">
                <div className="flex flex-col w-full">
                  <p className="line-clamp-2 text-[13px] tracking-[0.01em] leading-[17px] text-ellipsis font-medium dark:text-gray-100">
                    {citation.title}
                  </p>
          ...
          >
            <div className="flex pl-[12px] pt-[12px]">
              ...
              <div className="flex flex-col mr-[12px]">
                <span className="line-clamp-2 text-[13px] tracking-[0.01em] leading-[17px] text-ellipsis font-medium dark:text-gray-100">
                  {citation.title}
                </span>
