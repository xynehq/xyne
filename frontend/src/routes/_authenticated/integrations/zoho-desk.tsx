  ...
  const handleOAuth = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Please complete the Zoho authentication in the popup window.",
      })
        ...
        <div className="flex flex-col h-full items-center justify-center">
          <Card className="w-[500px]">
            <CardHeader>
              ...
              <CardDescription>
                Authenticate with your Zoho account to access support tickets from your department
              </CardDescription>
            </CardHeader>
            <CardContent>
              {isPending ? (
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-green-700 dark:text-green-300 mt-1">
                          You can now access Zoho Desk tickets from your department
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400 space-y-2">
                    ...
                    {zohoDeskConnector.subject && (
                      <p>
                        <strong>Department:</strong> {zohoDeskConnector.subject}
                      </p>
                    )}
                  </div>
                </div>
            ...
            <div className="mt-6 w-[500px]">
              <Card>
                ...
                <CardContent className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                  <p>
                    <strong>Access Control:</strong> You can only see tickets from your department
                  </p>
                  <p>
                    <strong>Data Sync:</strong> Tickets are synced daily by the admin
                  </p>
                  <p>
                    <strong>Search:</strong> Use the chat interface to search tickets
                  </p>
                </CardContent>
              </Card>
            </div>
