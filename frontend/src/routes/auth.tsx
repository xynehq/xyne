...
export default function LoginForm() {
  ...
  return (
    ...
    >
      ...
      <div className="bg-white rounded-3xl overflow-hidden absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-black max-w-[1168px] h-[630px] px-[17px] py-[13px]">
        ...
        <div className="flex w-full h-full gap-4">
          ...
          >
            {/* Text Content */}
            <div className="relative z-10 text-white flex flex-col items-start h-full pt-[60%] pl-[30px] pr-[65px] pb-[45px] gap-4">
              {/* Main Heading */}
              <h1 className="text-[32px] font-semibold leading-normal tracking-[0.2px] max-w-[400px] -ml-[15px]">
              ...
              {/* Description */}
              <p className="text-base font-normal leading-normal tracking-[0.2px] text-white/90 -ml-[15px]">
                The full-stack AI OS that's open-source,
                <br />
                on-prem, and enterprise-grade with determinism &<br />
          ...
          <div className="rounded-2xl flex flex-col items-center justify-center text-black w-[533px] h-[604px] px-10 pt-[45px] pb-[50px] gap-[70px] bg-transparent">
            {/* Xyne Logo */}
            <div className="-mt-5">
              <XyneLogo />
            </div>
            ...
            <div className="w-full flex flex-col items-center gap-[50px]">
              ...
              <div className="text-center flex flex-col gap-2">
                <h2 className="font-bold text-xl font-inter text-[#3B4145] leading-normal">
                  Welcome Back
                </h2>
                <p className="text-xs font-inter font-normal text-[#788187] leading-normal">
              ...
              >
                <img src={googleIconSvg} alt="Google" className="h-5 w-5" />
